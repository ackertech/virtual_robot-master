 ...
 *  How to add Telemetry to see what is happening
 */

import virtual_robot.controller.LinearOpMode;
import virtual_robot.hardware.DCMotor;

public class TeleOpLesson4 extends LinearOpMode {                   // Define the Class
    ...
    public void telemetryStatus () {
        telemetry.addData("Drive State","Tank %d  Arcade %d", tankDrive, arcadeMode);
